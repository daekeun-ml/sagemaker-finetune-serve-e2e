...
!!! tip "어디서부터 읽을까"
    - **처음이라면** → [실행 런북](RUN_E2E.md)으로 순서대로 따라가세요.
...
| 문서 | 다루는 내용 |
|---|---|
| [전체 지도](00_overview.md) | 킷 구조, 노트북 ↔ 문서 매핑, 실행 순서 |
| [SageMaker 추론](01_sagemaker_inference.md) | real-time / serverless / async / batch 네 옵션과 선택 기준 |
| [파인튜닝](02_finetuning.md) | DLC + TRL/PEFT, Gemma 관용구, LoRA vs QLoRA, `MaxRuntimeExceeded` 함정 |
| [합성 데이터](03_synthetic_data.md) | Bedrock Converse grounded 생성, critique/refine, held-out 규율 |
| [Agentic loop](04_agentic.md) | Strands Agent — reasoning은 Claude, SLM은 tool로 |
| [서빙 컨테이너](05_serving_containers.md) | vLLM / SGLang / DJL LMI 비교, KV-shared 복원, OOM·절단 대응 |
